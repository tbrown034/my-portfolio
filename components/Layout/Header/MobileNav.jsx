...
export default function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Slide-out panel */}
      <div
        className={`fixed top-0 right-0 z-50 h-full w-72 bg-white dark:bg-neutral-900 border-l border-gray-200 dark:border-neutral-700 shadow-2xl transform transition-transform duration-300 ease-in-out ${
