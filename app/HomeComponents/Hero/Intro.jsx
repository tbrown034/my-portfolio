...
export default function Intro({ showDesktopLayout }) {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <a
              href="#about"
              className="inline-flex items-center gap-3 text-gray-900 dark:text-gray-100 group cursor-pointer mt-4"
            >
  ...
  return (
    <section className="space-y-4">
      ...
      <a
        href="#about"
        className="flex items-center gap-3 text-gray-900 dark:text-gray-100 group cursor-pointer mt-4 sm:hidden"
      >
        <span className="flex items-center gap-3 border-b-2 border-blue-800 dark:border-blue-300 group-hover:border-blue-900 dark:group-hover:border-blue-200 transition-colors duration-200">
          <span className="text-lg font-bold">
            Let's build something together
      ...
      {/* Navigation cards and contact links - mobile */}
      <div className="mt-6">
