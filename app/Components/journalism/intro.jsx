    ...
    <section>
      <div className="flex flex-col gap-4">
        ...
        <p className="text-xl leading-normal font-robotoSlab">
          ...
          everythign else in between. I regularly appeared on podcasts, Most
          recently, I was an investigative journalist with{" "}
          <span className=" px-0.5 bg-blue-300 rounded shadow-md dark:bg-blue-600 font-robotoSlab hover:underline whitespace-nowrap">
            Oklahoma Watch
          </span>
        ...
        <p className="text-xl leading-normal font-robotoSlab">
          ...
          <span className="whitespace-nowrap px-0.5 bg-blue-300 rounded shadow-md dark:bg-blue-600 font-robotoSlab hover:underline">
            Writer of the Year
          </span>{" "}
          in 2021 and Oklahoma SPJʼs{" "}
          <span className=" px-0.5 whitespace-nowrap bg-blue-300 rounded shadow-md dark:bg-blue-600 font-robotoSlab hover:underline">
            first place awards
          </span>{" "}
