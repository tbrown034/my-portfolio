...
export default function Resume() {
  return (
    <div className="flex gap-4 px-8 sm:px-16 md:px-24 lg:px-32 xl:px-40 ">
      <Link
        className="flex flex-col items-center flex-1 w-full gap-2 px-4 py-2 text-sm font-bold text-center text-blue-100 border-2 rounded-lg bg-blue-950 dark:bg-blue-950 sm:w-auto hover:bg-blue-300 active:bg-blue-400"
        href="/"
      >
