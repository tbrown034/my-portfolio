...
export default function Resume() {
  return (
    <div className="flex items-center justify-center text-xl font-bold text-white rounded-full bg-blue-950 dark:text-blue-900 hover:bg-blue-700 dark:hover:bg-blue-300">
