...
export default function Contact() {
  ...
  return (
    <section className="w-full bg-gray-50 dark:bg-gray-900/50 min-h-[50vh] flex flex-col justify-center px-6 py-12 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-3 max-w-2xl">
              ...
              <div className="flex items-center justify-between p-4 border-l-2 border-blue-800 bg-white dark:bg-gray-800 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-l-4 group">
                ...
                >
                  <svg className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-blue-800 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <div>
                    <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">Email</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">trevorbrown.web@gmail.com</p>
                  </div>
                </a>
                <button
                  onClick={() => copyToClipboard('trevorbrown.web@gmail.com', 'email')}
                  className="p-2 text-gray-500 hover:text-blue-800 dark:text-gray-400 dark:hover:text-blue-400 transition-colors"
                  title="Copy email"
                >
                  {copiedItem === 'email' ? (
                    <svg className="w-5 h-5 text-green-800 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center justify-between p-4 border-l-2 border-blue-800 bg-white dark:bg-gray-800 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-l-4 group">
                <a 
                  href="https://www.linkedin.com/in/trevor-brown-323a162a9/" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 group"
                >
                  <svg className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-blue-800 dark:group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                  <div>
                    <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">LinkedIn</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">trevor-brown-323a162a9</p>
                  </div>
                </a>
                <button
                  onClick={() => copyToClipboard('https://www.linkedin.com/in/trevor-brown-323a162a9/', 'linkedin')}
                  className="p-2 text-gray-500 hover:text-blue-800 dark:text-gray-400 dark:hover:text-blue-400 transition-colors"
              ...
              <div className="flex items-center justify-between p-4 border-l-2 border-blue-800 bg-white dark:bg-gray-800 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-l-4 group">
                <a 
                  href="https://bsky.app/profile/trevthewebdev.bsky.social" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 group"
                >
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">Bluesky</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">@trevthewebdev.bsky.social</p>
                  </div>
                </a>
                <button
                  onClick={() => copyToClipboard('@trevthewebdev.bsky.social', 'bluesky')}
                  className="p-2 text-gray-500 hover:text-blue-800 dark:text-gray-400 dark:hover:text-blue-400 transition-colors"
