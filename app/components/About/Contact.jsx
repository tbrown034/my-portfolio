      ...
      <div className="max-w-7xl mx-auto w-full animate-fadeInUp">
        ...
        <div className="space-y-6 max-w-4xl">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
            <p className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-6">Reach out directly:</p>
            <div className="space-y-4">
              {/* Email */}
              <a 
                href="mailto:trevorbrown.web@gmail.com" 
                className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors group"
              >
                <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-lg bg-white dark:bg-gray-900 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/20 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100 break-all sm:break-normal">trevorbrown.web@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">LinkedIn</p>
                  <p className="text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100">linkedin.com/in/trevor-brown-323a162a9</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">Bluesky</p>
                  <p className="text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100">@trevthewebdev.bsky.social</p>
                </div>
              </a>
            </div>
          </div>
