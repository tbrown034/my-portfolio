          ...
          <div>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
              {techs.map((tech) => (
                ...
                >
                  <tech.Icon className="w-8 h-8 mb-2 text-gray-700 dark:text-slate-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200" />
