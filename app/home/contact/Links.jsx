  ...
  return (
    <section className="pb-8">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        {/* Email */}
        <div className="flex-1 flex items-center justify-between p-4 border-l-2 border-blue-800 bg-white dark:bg-slate-800 rounded-lg transition-all duration-300 hover:shadow-md hover:border-l-4">
          <a
            href={`mailto:${PERSONAL_INFO.email}`}
            className="flex items-center gap-3 group"
          >
            <svg
              className="w-5 h-5 text-gray-600 dark:text-slate-100 group-hover:text-blue-800 dark:group-hover:text-blue-400 hover:underline transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-slate-100 hover:underline">
                {PERSONAL_INFO.email}
              </p>
            </div>
          </a>
          <button
            ...
            className="p-2 text-gray-500 hover:text-blue-800 dark:text-slate-400 dark:hover:text-blue-400 transition-colors"
            title="Copy email"
          >
            {copiedItem === "email" ? (
              <svg
