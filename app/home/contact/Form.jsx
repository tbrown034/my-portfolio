...
export default function Form() {
  ...
  return (
    <div>
      ...
      <div className="p-8 md:p-10 rounded-2xl border-2 border-gray-300 dark:border-neutral-700 bg-linear-to-br from-white/80 to-white/60 dark:from-neutral-800/50 dark:to-neutral-800/30 backdrop-blur-md shadow-xl dark:shadow-2xl dark:shadow-black/40">
